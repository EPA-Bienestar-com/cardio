                                          ...
                                          {resource.payload.map((content, contentIndex) => (
                                            <React.Fragment key={contentIndex}>
                                              ...
                                              {content.contentAttachment?.url && (
                                                ...
                                                >
                                                  <DocumentArrowDownIcon className="mr-1 h-6 w-6 text-yellow-600 group-hover:text-yellow-700" />
                                                  Descargar adjunto
                                                </a>
                                              )}
                                            </React.Fragment>
                      ...
                      <div>
                        <UploadButton onUpload={(value: Attachment) => setAttachment(value)}>
                          <div className="group flex">
                            <div className="flex items-center rounded-l-md bg-yellow-600 px-2 group-hover:bg-yellow-700">
                              {attachment ? (
